...
const ParticipantItem: React.FC<{ role: string; name: string }> = ({
  role,
  name,
}) => (
...
export const CaseInfoPanel: React.FC = () => {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 space-y-6 h-full">
      <h2 className="text-xl font-bold font-serif text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-3">
        Case Details
      </h2>
      ...
      <h3 className="text-lg font-bold font-serif text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-3">
        Participants
      </h3>
      <div className="space-y-4">
