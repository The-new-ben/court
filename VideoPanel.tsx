...
const VideoFeed: React.FC<{
  ...
  isJudge?: boolean;
  isLive?: boolean;
}> = ({ name, role, isJudge = false, isLive = false }) => (
  <div
    className={`relative rounded-lg overflow-hidden shadow-lg ${isJudge ? "col-span-2" : ""} bg-gray-700 dark:bg-gray-900 border border-gray-600 dark:border-gray-700`}
  >
    <div className="aspect-video w-full flex items-center justify-center">
      {isJudge ? (
        <GavelIcon className="w-12 h-12 text-gray-500" />
      ) : (
